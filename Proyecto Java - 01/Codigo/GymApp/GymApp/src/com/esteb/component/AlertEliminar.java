...
public class AlertEliminar extends javax.swing.JPanel {
    private String info;
  
    public AlertEliminar() {
        this.info = info;
        initComponents();
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        btnCancelar = new com.esteb.swing.ButtonV3();
        ...
        jLabel1.setText("ESTAS A UN CLICK DE ELIMINAR D:");

        txt.setFont(new java.awt.Font("Roboto Mono", 0, 12)); // NOI18N
        txt.setForeground(new java.awt.Color(132, 132, 132));
        txt.setText("Verifica que la informacion que vas a ELIMINAR no sea sensible!");
    ...
    private com.esteb.swing.ButtonV3 btnCancelar;
